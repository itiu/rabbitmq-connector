	...
	void listener()
	{
		...
		while(true)
		{
			...
			try
			{
				...
				amqp_queue_declare_ok_t_* r = amqp_queue_declare(&conn, 1, AMQP_EMPTY_BYTES, 0, 1, 0, 0, AMQP_EMPTY_TABLE);
...
//					printf("Result %d\n", result);
					...
					while(body_received < body_target)
					{
						...
						message_acceptor(message, *ptr_frame_payload_body_fragment_len, this);
					}
